...
const SignIn: React.FC = () => {
  ...
  const getRedirectedPath = () => {
    if (!!redirectedFromPath && redirectedFromPath !== routes.HOME_PAGE)
      return redirectedFromPath;
    else return routes.DASHBOARD_LAYOUT;
  };
  ...
  return (
    <div className="flex min-h-screen max-w-[100rem]">
      <figure className="sticky top-0 hidden h-screen lgxl:block">
        <img src={AuthHero} className="h-screen" alt="hero" />
      </figure>

      <section className="flex flex-1 flex-col items-center bg-white px-5">
        <main className="mx-auto w-full max-w-[28.875rem] pt-4 font-poppins">
          ...
          <h1 className="mb-4 mt-7 text-center text-xl font-normal md:text-2xl lg:text-3xl">
            Sign-In to Semibill
          </h1>
          <h2 className="mb-14 px-5 text-center text-sm font-light sm:text-base">
            Get onboarded to fully enjoy every single one of our services at
            your fingertips
          </h2>

          <form onSubmit={onSubmit} className="mb-10 flex flex-col gap-y-6">
            <div>
              <label htmlFor="email" className="mb-2 font-medium">
                Email or Phone Number*
              </label>
              <div>
                <div className="rounded-md border border-appGray800 px-4 transition-all duration-300 focus-within:border-appPurple100">
                  <input
                    type="email"
                    id="email"
                    className="h-12 w-full outline-0 placeholder:text-sm placeholder:font-light"
                    autoComplete="email"
            ...
            <button
              type="submit"
              className="w-full rounded-lg bg-appDark400 py-4 font-medium text-white shadow-md transition-all duration-300 hover:scale-105 active:scale-95"
            >
              Sign In
            </button>
            ...
            <button
              type="button"
              className="mx-auto flex max-w-max items-center gap-5 rounded-xl border border-appGray900 px-7 py-3 text-sm font-medium sm:text-base"
            >
              <svg
                width="22"
                height="22"
              ...
              >
                <path
                  d="M21.5623 11.2639C21.5623 10.521 21.4904 9.7541 21.3705 9.03516H10.9938V13.2769H16.9371C16.6974 14.6429 15.9066 15.8411 14.7323 16.608L18.2791 19.3639C20.364 17.4228 21.5623 14.595 21.5623 11.2639Z"
                  fill="#4280EF"
                />
                <path
                  d="M10.9938 22C13.9654 22 16.4577 21.0174 18.2791 19.3399L14.7323 16.6079C13.7497 17.2789 12.4796 17.6624 10.9938 17.6624C8.11803 17.6624 5.6976 15.7212 4.81091 13.1331L1.16827 15.9369C3.03752 19.6515 6.82394 22 10.9938 22Z"
                  fill="#34A353"
                />
                <path
                  d="M4.81091 13.1091C4.35558 11.7431 4.35558 10.2573 4.81091 8.89131L1.16828 6.06348C-0.389426 9.17889 -0.389426 12.8455 1.16828 15.9369L4.81091 13.1091Z"
                  fill="#F6B704"
                />
                <path
                  d="M10.9938 4.36199C12.5515 4.33803 14.0852 4.93714 15.2116 6.01555L18.351 2.85222C16.3619 0.98297 13.7258 -0.0235464 10.9938 0.000418253C6.82394 0.000418253 3.03752 2.34896 1.16827 6.06348L4.81091 8.89132C5.6976 6.27917 8.11803 4.36199 10.9938 4.36199Z"
                  fill="#E54335"
                />
              </svg>
            ...
            <h6 className="text-center text-sm text-appLight300/50">
              you can also sign-in in with your social media accounts
            </h6>
